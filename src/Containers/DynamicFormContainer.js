...
class NameForm extends Component { 
  ...
  // 		});
	...
	addMultipleChoicesList(){
      ...
      var options1= document.getElementById("multichoicform").elements["goal"].options;
      var goals=[];
        		...
        		<Col className="questionsMenu" sm="12" onClick={this.handleShow.bind(this)}>
  				...
  				<Modal show={this.state.preNum} onHide={this.handleClose.bind(this)}>
	          		<Modal.Body>
						...
						<Button className="btn-primary" onClick={this.addNumericQuestion.bind(this)}>Add</Button>
						<Button className="btn-primary" onClick={this.handleClose.bind(this)}>Close</Button>
						</form>
        		...
        		<Col className="questionsMenu" sm="12" onClick={this.handleShowMultiPre.bind(this)}>
  				...
  				<Modal show={this.state.premulti} onHide={this.handleCloseMultiPre.bind(this)}>
	          		<Modal.Body>
						...
						<Button className="btn-primary" onClick={this.addMultipleChoicesList.bind(this)}>Add</Button>
						<Button className="btn-primary" onClick={this.handleCloseMultiPre.bind(this)}>Close</Button>
						</form>
  ...
  addNasaTlx(){
	...
	assessmentQuestions(){
		...
		assessments.forEach(function(assessment,index){
			ques.push(
				<Button className="deleteButton" bsSize="xsmall" onClick={that.deleteQuestion.bind(that,index)}>
					{'Q ' + index}  X
				</Button>
				);
		});
		...
		return(
			...
			<div className="deleteQuestionMenu" >
